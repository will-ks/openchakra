...
import {ComponentType, previewDefaultProps, targetComponents} from "~componentDefs";
...
export const getDefaultFormProps = (type: ComponentType) => {
  const previewProps = previewDefaultProps[type]
  const defaultProps = targetComponents[type]!.defaultProps
